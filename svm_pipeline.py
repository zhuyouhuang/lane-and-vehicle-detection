#代码   https://github.com/ckirksey3/vehicle-detection-with-svm
...
def find_cars(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins,
    ...
    on_windows = []
    img = img.astype(np.float32)/255   #获取img的RGB
...
def vehicle_detection_svm2(image):
...
#   plt.hist(hist_features)
    ...
    draw_img=vehicle_detection_svm2(image)
    plt.title('svm')
    plt.imshow(draw_img)
    plt.show()
######################################################        
